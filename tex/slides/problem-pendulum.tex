...
{\footnotesize\begin{table} % problem specs
\begin{adjustbox}{width=\columnwidth}
\begin{tabular}[t]{cll}
    \toprule
    System & Property & Implementation \\
    \midrule
    \onslide<2->{\begin{tikzpicture}[baseline=(current bounding box.center)]
    ...
    \end{tikzpicture}}
    &
    \onslide<3->{\begin{tabular}{@{}l@{}} \textit{``Keep the pendulum balanced''} \\ $B(s_t)$: $|\theta_t| \le \pi/4$ \\ $\psi = \square B(s_t)$\end{tabular}}
    & 
