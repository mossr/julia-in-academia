...
\begin{tabular}[t]{cll}
    ...
    plot(p)
    \end{jlcode}
    \plot{fig/cas_system} \vspace{0.5cm}
    & \begin{tabular}{@{}l@{}} \textit{``Ensure at least 50 meters relative} \\ \textit{altitude between 40 and 41 seconds''} \\ $S(s_t)$: $|h_t| \ge 50$ \\ $\psi = \square_{[40,41]} S(s_t)$\end{tabular} & 
    \begin{tabular}{@{}l@{}}
